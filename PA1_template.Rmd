...
```{r echo=FALSE}
plot(tabela4[,1], main="Weekdays", xlab="interval",ylab="steps", tabela4[,2], type="l")
plot(tabela5[,1], main="Weekends", xlab="interval",ylab="steps", tabela5[,2], type="l")
```
